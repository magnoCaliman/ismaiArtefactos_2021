...
# void loop()
# {
#   tone(pinoPiezzo, random(100, 500), 90);
#   delay(tempoDelay);
# }
# #+END_SRC

# - Pergunta. Sem avaliar o código, conseguem dizer qual a diferença de comportamento entre os Ex.2 e Ex.3 abaixo?
...
# void loop()
# { 
#   tone(pinoPiezzo, 100, 90);
#   delay(random(100, 1000));
#   tone(pinoPiezzo, 200, 90);
#   delay(random(100, 1000));
#   tone(pinoPiezzo, 300, 90);
#   delay(random(100, 1000));
#   tone(pinoPiezzo, 400, 90);
#   delay(random(100, 1000));
# }
# #+END_SRC
...
# void loop()
# {
#   tone(pinoPiezzo, random(100, 500));
# }
# #+END_SRC

# - Ex.n
#   - Agora mais organizado, guardando o valor em uma variável:
# [talvez exemplo com 3 leds ligando e desligando? tem led rgb no kit?]
# #+BEGIN_SRC c
# void setup()
# {
...
# #+END_SRC
# ** Comunicação Serial
# - No Ex.2 temos ~tempoDelay = random(100, 1000)~. Perguntas:
#   - /Onde/ esse número está sendo gerado?
