...
- Tensão
  - Todo circuito espera uma "/quantidade/" certa de eletricidade fluindo entre os polos positivo e negativo. Por vezes, não há problemas em operar um pouco acima ou abaixo desse valor ideal (um engenheiro vai te dizer o contrário...).
